...
public:
	...
	std::shared_ptr<IModel> LoadModel(const std::string& ModelFileName, const std::shared_ptr<IznLoaderParams>& LoaderParams = nullptr) const override;
	...
	// IFBXSceneLoader
	std::shared_ptr<IFBXScene> LoadScene(const std::string& ModelFileName, const std::shared_ptr<IznLoaderParams>& LoaderParams) const override;
	std::shared_ptr<IFBXScene> LoadScene(const std::shared_ptr<IFile>& ModelFile, const std::shared_ptr<IznLoaderParams>& LoaderParams) const override;
