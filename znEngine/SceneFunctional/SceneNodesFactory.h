...
public:
	...
	std::shared_ptr<ISceneNode3D> CreateSceneNode3D(ISceneNode3D* Parent, std::string SceneNodeTypeName) const override;
	std::shared_ptr<ISceneNodeUI> CreateSceneNodeUI(ISceneNodeUI* Parent, std::string SceneNodeTypeName) const override;
