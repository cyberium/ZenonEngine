...
public:
	...
	std::shared_ptr<IRenderPass> CreateRenderPass(std::string RenderPassName, IRenderDevice* RenderDevice, IRenderTarget* RenderTarget, const Viewport * Viewport, std::shared_ptr<IScene> Scene) const override;
