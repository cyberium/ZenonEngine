...
public:
	...
	std::shared_ptr<IRenderPass> CreateRenderPass(std::string RenderPassName, std::shared_ptr<IRenderDevice> RenderDevice, std::shared_ptr<IRenderTarget> RenderTarget, const Viewport * Viewport, std::shared_ptr<IScene> Scene) const override;
