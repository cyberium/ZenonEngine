...
// IVisitor
//
bool CMaterialPassOpaque::Visit(const IModel * Model)
{
	return Base3DPass::Visit(Model);
}

bool CMaterialPassOpaque::Visit(const IGeometry * Geometry, const IMaterial* Material, SGeometryDrawArgs GeometryDrawArgs)
{
