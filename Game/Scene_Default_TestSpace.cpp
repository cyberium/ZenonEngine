...
void CSceneDefault::Load3DOld()
{
	...
	//m_Technique3D.AddPass(MakeShared(CParticlesPass, GetRenderDevice(), shared_from_this())->ConfigurePipeline(GetRenderWindow()->GetRenderTarget(), &GetRenderWindow()->GetViewport()));
}
