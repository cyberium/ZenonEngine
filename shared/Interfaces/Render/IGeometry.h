...
ZN_INTERFACE ZN_API IGeometry : public std::enable_shared_from_this<IGeometry>
{
	...
	virtual bool RenderInstanced(const RenderEventArgs* renderArgs, const IStructuredBuffer* InstancesBuffer, const ShaderMap& ShadersMap, const IMaterial* Material, SGeometryPartParams GeometryPartParams) const = 0;
