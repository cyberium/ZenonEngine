...
ZN_INTERFACE ZN_API IDepthStencilState
{
	/**
	 * Used to enable or disable depth buffer writes.
	 */
	enum class ZN_API DepthWrite
	{
		Enable,
		Disable
	};
	 ...
	 * @see IDepthStencilState::DepthMode::DepthFunction
	 * @see IDepthStencilState::StencilMode::StencilFunction
	 */
	enum class ZN_API CompareFunction
	{
	 ...
	 * @see IDepthStencilState::StencilMode.
	 */
	enum class ZN_API StencilOperation
	{
		Keep,           // Keep the existing value in the stencil buffer unmodified.
		Zero,           // Set the value in the stencil buffer to 0.
		Reference,      // Set the value in the stencil buffer to the reference value. @see IDepthStencilState::StencilMode::StencilReference.
	 ...
	 * or back facing (according to the value of IRasterizerState::FrontFacing).
	 */
	struct ZN_API FaceOperation
	{
		/**
		 ...
		 * @see IDepthStencilState::CompareFunction
		 */
