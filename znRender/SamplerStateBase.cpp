...
SamplerStateBase::SamplerStateBase()
    : m_MinFilter(MinFilter::MinLinear)
    , m_MagFilter(SamplerStateBase::MagFilter::MagLinear)
    , m_MipFilter(SamplerStateBase::MipFilter::MipLinear)
    , m_WrapModeU(WrapMode::Clamp)
    , m_WrapModeV(WrapMode::Clamp)
    , m_WrapModeW(WrapMode::Clamp)
    , m_CompareMode(CompareMode::None)
    , m_CompareFunc(CompareFunc::Never)
    , m_fLODBias(0.0f)
    , m_fMinLOD(Math::MinFloat)
    , m_fMaxLOD(Math::MaxFloat)
    , m_bIsAnisotropicFilteringEnabled(true)
