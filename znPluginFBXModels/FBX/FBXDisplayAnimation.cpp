...
void DisplayAnimation(fbxsdk::FbxAnimStack* pAnimStack, FbxNode* pNode, bool isSwitcher = false);
void DisplayAnimation(fbxsdk::FbxAnimLayer* pAnimLayer, FbxNode* pNode, bool isSwitcher = false);

void DisplayChannels(FbxNode* pNode, FbxAnimLayer* pAnimLayer, void(*DisplayCurve) (fbxsdk::FbxAnimCurve* pCurve), void(*DisplayListCurve) (fbxsdk::FbxAnimCurve* pCurve, fbxsdk::FbxProperty* pProperty), bool isSwitcher);
void DisplayCurveKeys(fbxsdk::FbxAnimCurve* pCurve);
void DisplayListCurveKeys(fbxsdk::FbxAnimCurve* pCurve, FbxProperty* pProperty);
...
{
	fbxsdk::FbxAnimCurve* lAnimCurve = NULL;
...
void DisplayCurveKeys(FbxAnimCurve* pCurve)
{
	...
	for (int lCount = 0; lCount < (lKeyCount > 4 ? 4 : 0); lCount++)
	{
