...
Database::AsyncQuery(Class *object, void (Class::*method)(QueryResult*), const char *sql)
{
    ...
    return m_threadBody->Delay(new SqlQuery(sql, new QueryCallback<Class>(object, method), itr->second));
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    return m_threadBody->Delay(new SqlQuery(sql, new QueryCallback<Class, ParamType1>(object, method, (QueryResult*)NULL, param1), itr->second));
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    return m_threadBody->Delay(new SqlQuery(sql, new QueryCallback<Class, ParamType1, ParamType2>(object, method, (QueryResult*)NULL, param1, param2), itr->second));
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    return m_threadBody->Delay(new SqlQuery(sql, new QueryCallback<Class, ParamType1, ParamType2, ParamType3>(object, method, (QueryResult*)NULL, param1, param2, param3), itr->second));
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    return m_threadBody->Delay(new SqlQuery(sql, new SQueryCallback<ParamType1>(method, (QueryResult*)NULL, param1), itr->second));
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    return m_threadBody->Delay(new SqlQuery(sql, new SQueryCallback<ParamType1, ParamType2>(method, (QueryResult*)NULL, param1, param2), itr->second));
}
...
{
    ASYNC_QUERY_BODY(sql, itr)
    return m_threadBody->Delay(new SqlQuery(sql, new SQueryCallback<ParamType1, ParamType2, ParamType3>(method, (QueryResult*)NULL, param1, param2, param3), itr->second));
}
...
Database::DelayQueryHolder(Class *object, void (Class::*method)(QueryResult*, SqlQueryHolder*), SqlQueryHolder *holder)
{
    ...
    return holder->Execute(new QueryCallback<Class, SqlQueryHolder*>(object, method, (QueryResult*)NULL, holder), m_threadBody, itr->second);
}
...
{
    ASYNC_DELAYHOLDER_BODY(holder, itr)
    return holder->Execute(new QueryCallback<Class, SqlQueryHolder*, ParamType1>(object, method, (QueryResult*)NULL, holder, param1), m_threadBody, itr->second);
}
