...
CEditor3DToolRotator::~CEditor3DToolRotator()
{
}

void CEditor3DToolRotator::Initialize()
{
...
void CEditor3DToolRotator::Finalize()
{
}

void CEditor3DToolRotator::Enable()
{
...
bool CEditor3DToolRotator::OnMousePressed(const MouseButtonEventArgs & e, const Ray & RayToWorld)
{
	if (!IsEnabled())
		return false;
...
void CEditor3DToolRotator::OnMouseReleased(const MouseButtonEventArgs & e, const Ray & RayToWorld)
{
	if (!IsEnabled())
		return;
...
void CEditor3DToolRotator::OnMouseMoved(const MouseMotionEventArgs & e, const Ray & RayToWorld)
{
	if (!IsEnabled())
		return;
