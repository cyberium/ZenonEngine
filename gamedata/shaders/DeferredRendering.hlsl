...
Texture2D DiffuseTextureVS : register(t0); // The diffuse color from the view space texture.
Texture2D SpecularTextureVS : register(t1); // The specular color from the screen space texture.
Texture2D NormalTextureVS : register(t2); // The normal from the screen space texture.
Texture2D DepthTextureVS : register(t3); // The depth from the screen space texture.
